        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="inputBox">
                    ...
                    <input type="text" name="cat_name" placeholder="Enter category name" autocomplete="off" id="cat_name" required>
                </div>
...
<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql=" INSERT INTO categories (category_name,images) VALUES ('$cat_name','$dst_db') ";
